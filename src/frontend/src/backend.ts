...
export class Backend implements backendInterface {
    ...
    async addGalleryPhoto(arg0: Input__1): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getAllContactSubmissions(): Promise<Array<Input>> {
        if (this.processError) {
            try {
    ...
    async getAllGalleryPhotos(): Promise<Array<Output>> {
        if (this.processError) {
            try {
    ...
    async getContactSubmission(arg0: string): Promise<Input> {
        if (this.processError) {
            try {
    ...
    async removeGalleryPhoto(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeGalleryPhoto(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitForm(arg0: Input): Promise<void> {
        if (this.processError) {
            try {
